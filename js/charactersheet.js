...
function centerPortrait(portrait){
    portrait.style.left = (parseInt(portrait.style.left.slice(0,-2))+(446-portrait.clientWidth)/2)+"px";
    portrait.style.top = (parseInt(portrait.style.top.slice(0,-2))+(480-portrait.clientHeight)/2)+"px";
}
